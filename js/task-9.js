...
// console.log(isLoginValid('Ajax')); //my console
function isLoginUnique(allLogins, login) {
  return !allLogins.includes(login);
}
// console.log(
//   isLoginUnique(
//     ['Mango', 'robotGoogles', 'Poly', 'Aj4x1sBozz', 'qwerty123'],
//     'Ajax',
//   ),
// ); //my console
function addLogin(allLogins, login) {
  ...
  if (!isLoginValid(login)) {
    ...
    logins.push(login); // моя версия
    // allLogins.push(login); // версия для принятия ботом
    message = SUCCESS;
  }
  return message;
}
